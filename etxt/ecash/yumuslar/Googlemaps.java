...
public class Googlemaps extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_googlemaps, container, false);
        ...
        dili=view.findViewById(R.id.tesdili);
        gornus=view.findViewById(R.id.tematika);
        Editname=view.findViewById(R.id.nameOf);
        Editsimsan=view.findViewById(R.id.sanysim);
        yumusany=view.findViewById(R.id.yumusany);
        ...
        tesgor="Umumy";
        Editdusungoogle=view.findViewById(R.id.Editdusungoogle);
        sendgooglemap=view.findViewById(R.id.sendgooglemap);
        ...
        insertmaps=view.findViewById(R.id.insertmaps);
        ...
        sendgooglemap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                insertmaps.loadUrl("http://"+ipaddress+"/etm/insert.php?name="+nameof+"&zakazid="+zakazid+"&jemi="+zadaniyasany+
                    ...
                    Log.e("Google", "http://"+ipaddress+"/etm/insert.php?name="+nameof+"&zakazid="+zakazid+"&jemi="+zadaniyasany+
